import 'package:chatboss/chat/showdetilasch.dart';
...
class Chatviwe extends StatefulWidget {
  final img, name, id, typer, roomid;
  const Chatviwe(
      {Key? key,
      required this.img,
      required this.name,
  ...
  @override
  _ChatviweState createState() => _ChatviweState();
}

class _ChatviweState extends State<Chatviwe> {
  var idm;
