...
class showdetilasgroup extends StatefulWidget {
  final name, img, id;
  const showdetilasgroup(
      {Key? key, required this.img, required this.name, required this.id})
      : super(key: key);

  @override
  _showdetilasgroupState createState() => _showdetilasgroupState();
}

class _showdetilasgroupState extends State<showdetilasgroup> {
  @override
